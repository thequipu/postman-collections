...
def generate():
    ...
    items = [
        ...
        *full_setup_steps("01", "pm-flow-ns", include_realm=True, base=base),
        ...
        req("03 Create Namespace", "POST", "/namespace?realmId={{realmId}}",
            ...
            base=base, body={"name": "pm-flow-ns-{{$timestamp}}", "description": "FLOW"}),
        ...
        req("08 Add Source", "POST", "/namespace/{{nsId}}/source",
            ...
            base=base, body={"dataSourceId": 0, "name": "pm-flow-source"},
            prerequest=["pm.request.body.raw=JSON.stringify({dataSourceId:parseInt(pm.collectionVariables.get('dsId')),name:'pm-flow-source'});"]),

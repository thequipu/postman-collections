...
def generate():
    ...
    items = [
        ...
        req("01 Create DB DataSource", "POST", "/datasource",
            ...
            base=base,
            body={"name": "pm_flow_dsext_{{$timestamp}}",
        ...
        req("12 Create CSV DataSource", "POST", "/datasource",
            ...
            base=base,
            body={"name": "pm_flow_csv_{{$timestamp}}", "driverType": "CSV",
        ...
        req("14 Create Excel DataSource", "POST", "/datasource",
            ...
            base=base,
            body={"name": "pm_flow_excel_{{$timestamp}}", "driverType": "EXCEL",
        ...
        req("16 Create PDF DataSource", "POST", "/datasource",
            ...
            base=base,
            body={"name": "pm_flow_pdf_{{$timestamp}}", "driverType": "PDF",
